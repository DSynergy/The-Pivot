...
jQuery.url = function()
{
    ...
    */
     ...
     * Returns the value of the required query string parameter.
  	 * 
	 * @param string listing The parameter whose value is required
     */		
	var param = function( listing )
	{
		if ( ! parsed.length )
		{
			setUp(); // if the URI has not been parsed yet then do this first...	
		}
		return ( parsed.queryKey[listing] === null ) ? null : parsed.queryKey[listing];
	};
